...
function encryptBlock(message, e, n) {
...
function encryptText(text, e, n) {
    ...
    for (let i = 0; i < data.length; i += blockSize) {
        ...
        if (blockNumber >= n) {
            throw new Error(`Bloco de índice ${i} gerou um valor (${blockNumber}) maior ou igual a n (${n}). Use chaves maiores.`);
        }
